...
String_indexOf_3:
    ...
    // Length of str
    BL      String_length                      // Branches to length to get the length of str
    MOV     X21, X0                     // Stores the length into X21

    // Length of substring
    MOV     X0, X20                     // Moves the address of the substring into X0
    BL      String_length                      // Branches to length to get the length of the substring
...
String_lastIndexOf_1:
    ...
    BL      String_length                          // Branches to length
